...
namespace codegym::runtime
{
    ...
    {
        static InputCode::Key GLFWToLumosKeyboardKey(uint32_t glfwKey)
        {
            static std::map<uint32_t, InputCode::Key> keyMap = {
                ...
                { GLFW_KEY_TAB, InputCode::Key::Tab }
            };

            return keyMap[glfwKey];
        }

        static InputCode::MouseKey GLFWToLumosMouseKey(uint32_t glfwKey)
        {
